        ...
        if (brick_array[brick_index].occupancy & ((uint64_t)1 << sub_brick_index)) {
            switch(last_step) {
                case 1:
                    ...
                    ray->pos.y = init_ray_pos.y + curr_t*ray->dir.y;
                    ray->pos.z = init_ray_pos.z + curr_t*ray->dir.z;
                    break;
                case 2:
                    ray->pos.x = init_ray_pos.x + curr_t*ray->dir.x;
